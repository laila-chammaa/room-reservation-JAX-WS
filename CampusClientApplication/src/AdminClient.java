...
public class AdminClient {
    ...
    public synchronized void createRoom(int roomNumber, String date, ArrayList<Timeslot> listOfTimeSlots) {
    ...
    public synchronized void deleteRoom(int roomNumber, String date, ArrayList<Timeslot> listOfTimeSlots) {
